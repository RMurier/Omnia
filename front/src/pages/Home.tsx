...
export default function Home() {
  ...
  useEffect(() => {
    ...
    authFetch<DashboardStats>("/log/dashboard")
    ...
    <div className="animate-page" style={styles.page}>
      ...
      {isAuthenticated && (
        <div style={styles.dashSection}>
          {dashboardLoading && (
            <p style={styles.muted}>{t("me.dashboardLoading")}</p>
          )}

          {!dashboardLoading && dashboard && Object.keys(dashboard.apps).length === 0 && (
