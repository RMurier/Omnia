...
export default function Documentation() {
  ...
  return (
    <div style={{ display: "flex", flex: 1, minHeight: 0, overflow: "hidden", background: "var(--color-surface-sunken)" }}>
      ...
      <main style={{ flex: 1, overflowY: "auto", padding: isTablet ? "24px 16px" : "32px 48px" }}>
