  ...
  return (
    <div className="animate-page" style={styles.page}>
      <section style={styles.card}>
        <div style={styles.badge}>{t("app.name")}</div>
        <h1 style={styles.title}>{t("about.title")}</h1>
        <p style={styles.text}>{t("about.description")}</p>
      </section>

      <section style={styles.card}>
        <h2 style={styles.discordTitle}>{t("about.discordTitle")}</h2>
        <p style={styles.discordText}>{t("about.discordDescription")}</p>
        <a
          href={DISCORD_URL}
          target="_blank"
